...
function ContactForm({ setContactForm, darkMode }) {
    ...
    onSubmit: async (values, { resetForm }) => {
      try {
        const response = await fetch(
          "https://app.sbcapprenticeship.com/api/contact-form",
          {
            method: "POST",
            headers: {
      ...
      <div className="contact-wrapper">
        ...
        <div className="contact-form-right">
          <div className="inner-contact-form-right">
            ...
            <ul className="follow">
              <li>
                <a href="https://www.facebook.com/sbcapprenticeship/">
                  <FaFacebookF size={24} />
                </a>
              </li>
              <li>
                <a href="https://twitter.com/i/flow/login?redirect_after_login=%2Fcuts_san">
                  <FaTwitter size={24} />
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/sbcapprenticeship/?hl=en">
                  <FaInstagram size={24} />
                </a>
              </li>
            </ul>
